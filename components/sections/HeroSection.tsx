...
export function HeroSection() {
  ...
  return (
    <section
      id="top"
      className="relative min-h-[92svh] overflow-hidden bg-ink-black px-5 pt-32 sm:px-8 lg:pt-36"
    >
      <Image
        src={hero.image}
      ...
      <div className="relative z-10 flex min-h-[calc(92svh-8rem)] w-full flex-col justify-center pb-20 pt-8 lg:pl-8 xl:pl-10 2xl:pl-12">
        <Reveal className="max-w-[840px]">
          ...
          <div className="mt-7 max-w-[780px] space-y-4 text-base font-medium leading-7 text-ink-muted sm:text-[1.03rem] lg:text-[1.08rem]">
